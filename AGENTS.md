...
Keep physical calculations on the fine grid until the final overlap-based location aggregation. Preserve hectares and water budgets separately from effective cropland. Starting population is contextual, never a fitting target.
