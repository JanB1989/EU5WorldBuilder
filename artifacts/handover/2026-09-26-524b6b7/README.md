# World Builder handover 2026-09-26-524b6b7

Schema 1.0, World Builder commit `524b6b7`. All values in people (1 game unit = 1,000 people).
...
Verify a rescaled or rounded levels table with `worldbuilder handover-check --levels <csv> --units <json> --version 2026-09-26-524b6b7`.
