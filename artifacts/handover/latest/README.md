# World Builder handover 2026-09-23-91324f8

Schema 1.0, World Builder commit `91324f8`. All values in people (1 game unit = 1,000 people).
...
| goods_floor.csv | 1875 | RGO locations for the floor carve-out |
...
Verify a rescaled or rounded levels table with `worldbuilder handover-check --levels <csv> --units <json> --version 2026-09-23-91324f8`.
