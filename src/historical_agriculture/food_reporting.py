...
<p class="note">The food-system mask is complete on the GAEZ land domain. Non-crop numerical estimates remain experimental: foraging uses a modern-climate process model; livestock uses a provisional biomass-to-herd conversion. Lower/upper non-crop values are analogue/model scenarios, not established medieval limits. UNQUANTIFIED land cells remain unquantified.</p>
"""
