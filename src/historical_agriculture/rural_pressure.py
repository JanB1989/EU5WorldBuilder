...
def report(root,out,current,fingerprint):
    ...
    if baseline.exists():
        ...
        for col in ['starting_capacity','maximum_capacity']:
            ...
            if (physical_delta < -tolerance).any():raise ValueError('Voluntary-management envelope decreased pre-floor support: '+col)
