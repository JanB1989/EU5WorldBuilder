...
def test_bank_detour_gives_the_other_bank_the_mainstem_level():
    ...
    report = rc.complete(native, sizes, owner, markers, zones, inv, blocked, {"bank_detours": True, "fallback_pieces": False})
...
def test_vanilla_piece_is_copied_as_its_own_tree_with_clearance():
    native, sizes, owner, markers, zones, inv, blocked = _canvas()
    report = rc.complete(native, sizes, owner, markers, zones, inv, blocked, {"bank_detours": False, "fallback_pieces": True, "minimum_piece_pixels": 3})
